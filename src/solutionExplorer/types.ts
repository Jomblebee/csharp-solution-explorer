...
export const MANAGE_LAUNCH_COMMAND_ID = "csharpSolutionExplorer.manageLaunch";
export const TOGGLE_LAUNCH_BROWSER_COMMAND_ID = "csharpSolutionExplorer.toggleLaunchBrowser";
